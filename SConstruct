...
def configuration_macosx(config, version, architecture) :
    ...
    config["linkto"]            = ["boost_thread", "boost_iostreams", "hdf5_cpp", "hdf5", "ginac", "atlas", "lapack", "ptcblas"]
...
def configuration_posix(config, version, architecture) :
    ...
    config["linkto"]            = ["boost_thread", "boost_iostreams", "hdf5_cpp", "hdf5", "ginac", "atlas", "lapack", "ptcblas", "ptf77blas"]
