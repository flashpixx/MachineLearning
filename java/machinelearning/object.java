...
public abstract class object {
    ...
    static { 
        ...
        // first try to load the JNI library, on exception extract the "native" subdirectory
        // of the Jar into a temporary directory and switch the path property
        try {
            ...
            // if it exists of a previous run, try to load again the library
            try {
                System.loadLibrary("machinelearning");
            ...
            try {
                ...
                // property values are cached so we clear the cache manually to allow reloading
                ...
                // load library
                System.loadLibrary("machinelearning");
            } catch(Exception e_reflect) { e_reflect.printStackTrace(); }
        }
    }
